...
public final  class rwdmasterpage_impl extends GXMasterPage
{
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, "FORM_MPAGE_Caption", GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getCaption()));
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, "FORM_MPAGE_Caption", GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getCaption()));
   }
   ...
   public void renderHtmlCloseForm042( )
   {
      ...
      httpContext.AddJavascriptSource("rwdmasterpage.js", "?202142316262028", false, true);
   ...
   public void wb040( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( ! ShowMPWhenPopUp( ) && httpContext.isPopUpObject( ) )
         {
            ...
            com.prebakb.GxWebStd.classAttribute( httpContext, "gx-content-placeholder");
         ...
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", "MainContainer", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, divHeader_Internalname, 1, 0, "px", 0, "px", "ContainerFluid HeaderContainer", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-10", "left", "top", "", "", "div");
         /* Text block */
         com.prebakb.GxWebStd.gx_label_ctrl( httpContext, lblApplicationheader_Internalname, "Application Name", "", "", lblApplicationheader_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlockHeader", 0, "", 1, 1, 0, (short)(0), "HLP_RwdMasterPage.htm");
         com.prebakb.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-2", "left", "top", "", "", "div");
         ...
         com.prebakb.GxWebStd.gx_bitmap( httpContext, imgImage1_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_RwdMasterPage.htm");
         com.prebakb.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.prebakb.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.prebakb.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.prebakb.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, divRecent_Internalname, 1, 0, "px", 0, "px", "ContainerFluid RecentLinksContainer", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         {
            /* WebComponent */
            com.prebakb.GxWebStd.gx_hidden_field( httpContext, "MPW0017"+"", GXutil.rtrim( WebComp_Wcrecentlinks_Component));
            httpContext.writeText( "<div") ;
            com.prebakb.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
         ...
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, divContent_Internalname, 1, 0, "px", 0, "px", "BodyContainer", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               else if ( GXutil.strcmp(sEvtType, "M") == 0 )
               {
                  ...
                  if ( nCmpId == 17 )
                  {
                     ...
                     {
                        WebComp_Wcrecentlinks = WebUtils.getWebComponent(getClass(), "com.prebakb." + OldWcrecentlinks + "_impl", remoteHandle, context);
   ...
   public void e12042( )
   {
      ...
      {
         WebComp_Wcrecentlinks = WebUtils.getWebComponent(getClass(), "com.prebakb.rwdrecentlinks_impl", remoteHandle, context);
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?202142316262118", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("rwdmasterpage.js", "?202142316262119", false, true);
