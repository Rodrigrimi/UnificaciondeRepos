...
public final  class rwdrecentlinks_impl extends GXWebComponent
{
   ...
   {
      com.prebakb.GxWebStd.gx_html_headers( httpContext, 0, "", "", Form.getMeta(), Form.getMetaequiv(), true);
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202142316263454", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.prebakb.rwdrecentlinks", new String[] {GXutil.URLEncode(GXutil.rtrim(AV6FormCaption)),GXutil.URLEncode(GXutil.rtrim(AV7FormPgmName))}, new String[] {"FormCaption","FormPgmName"}) +"\">") ;
         com.prebakb.GxWebStd.gx_hidden_field( httpContext, "_EventName", "");
         com.prebakb.GxWebStd.gx_hidden_field( httpContext, "_EventGridId", "");
         com.prebakb.GxWebStd.gx_hidden_field( httpContext, "_EventRowId", "");
      ...
      else
      {
         ...
         com.prebakb.GxWebStd.classAttribute( httpContext, "gxwebcomponent-body"+" "+((GXutil.strcmp("", Form.getThemeClass())==0) ? "form-horizontal Form" : Form.getThemeClass())+"-fx");
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_8", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_8, (byte)(8), (byte)(0), ".", "")));
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6FormCaption", GXutil.rtrim( wcpOAV6FormCaption));
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7FormPgmName", wcpOAV7FormPgmName);
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vFORMCAPTION", GXutil.rtrim( AV6FormCaption));
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vFORMPGMNAME", AV7FormPgmName);
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"MAINTABLE_Class", GXutil.rtrim( divMaintable_Class));
   }
   ...
   public void renderHtmlCloseForm052( )
   {
      ...
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GX_FocusControl", GX_FocusControl);
      define_styles( ) ;
   ...
   public void wb050( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.prebakb.rwdrecentlinks");
         }
         com.prebakb.GxWebStd.gx_msg_list( httpContext, "", httpContext.GX_msglist.getDisplaymode(), "", "", sPrefix, "false");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", " "+"data-gx-base-lib=\"bootstrapv3\""+" "+"data-abstract-form"+" ", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", divMaintable_Class, "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-2 col-md-1", "left", "top", "", "", "div");
         /* Text block */
         com.prebakb.GxWebStd.gx_label_ctrl( httpContext, lblRecenttext_Internalname, "Recents", "", "", lblRecenttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e11051_client"+"'", "", "RecentsTitle", 7, "", 1, 1, 0, (short)(0), "HLP_RwdRecentLinks.htm");
         com.prebakb.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.prebakb.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-10 col-md-11", "left", "top", "", "", "div");
         /*  Grid Control  */
         ...
         if ( LinksContainer.GetWrapped() == 1 )
         {
            ...
            sStyleString = "" ;
            com.prebakb.GxWebStd.gx_table_start( httpContext, subLinks_Internalname, subLinks_Internalname, "", "RecentLinksGrid", 0, "", "", 1, 2, sStyleString, "", "", 0);
      ...
      if ( wbEnd == 8 )
      {
         ...
         else
         {
            ...
            {
               com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LinksContainerData", LinksContainer.ToJavascriptSource());
            }
            if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
            {
               com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LinksContainerData"+"V", LinksContainer.GridValuesHidden());
            }
            else
            {
   ...
   public void we052( )
   {
      if ( ! com.prebakb.GxWebStd.gx_redirect( httpContext) )
      {
         Rfr0gs = true ;
         refresh( ) ;
         if ( ! com.prebakb.GxWebStd.gx_redirect( httpContext) )
   ...
   {
      com.prebakb.GxWebStd.set_html_headers( httpContext, 0, "", "");
      subsflControlProps_82( ) ;
   ...
   public void rf052( )
   {
      ...
      if ( subLinks_Islastpage != 0 )
      {
         ...
         com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LINKS_nFirstRecordOnPage", GXutil.ltrim( localUtil.ntoc( LINKS_nFirstRecordOnPage, (byte)(15), (byte)(0), ".", "")));
   ...
   private void e12052( )
   {
      ...
      {
         AV12RecentLinksItem = (com.prebakb.SdtLinkList_LinkItem)((com.prebakb.SdtLinkList_LinkItem)AV11RecentLinksItems.elementAt(-1+AV9i));
      ...
      AV12RecentLinksItem = (com.prebakb.SdtLinkList_LinkItem)new com.prebakb.SdtLinkList_LinkItem(remoteHandle, context);
   ...
   {
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6FormCaption_PARM", GXutil.rtrim( AV6FormCaption));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6FormCaption)) > 0 )
      {
         com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6FormCaption_CTRL", GXutil.rtrim( sCtrlAV6FormCaption));
      }
      com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7FormPgmName_PARM", AV7FormPgmName);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7FormPgmName)) > 0 )
      {
         com.prebakb.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7FormPgmName_CTRL", GXutil.rtrim( sCtrlAV7FormPgmName));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202142316263592", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("rwdrecentlinks.js", "?202142316263596", false, true);
   ...
   public void initialize( )
   {
      ...
      EvtRowId = "" ;
      sEvtType = "" ;
      AV11RecentLinksItems = new GXBaseCollection<com.prebakb.SdtLinkList_LinkItem>(com.prebakb.SdtLinkList_LinkItem.class, "LinkItem", "GeneXus", remoteHandle);
      AV8Session = httpContext.getWebSession();
      AV12RecentLinksItem = new com.prebakb.SdtLinkList_LinkItem(remoteHandle, context);
   ...
   private GXBaseCollection<com.prebakb.SdtLinkList_LinkItem> AV11RecentLinksItems ;
   private com.prebakb.SdtLinkList_LinkItem AV12RecentLinksItem ;
}
